...
--   VALUES ('userServer', '{bcrypt}$2y$12$.rOhnslnLiG/XL/WJlTDke0Fux3D0VIO7y9W7Hc6GdQ/jvghHd89a', 'read,write', 'password,refresh_token,client_credentials', 'ROLE_CLIENT', 300)
-- --userServerPassword
--
...
--
-- INSERT INTO users (id, username, password, enabled) VALUES (1, 'user', '{bcrypt}$2y$12$.rOhnslnLiG/XL/WJlTDke0Fux3D0VIO7y9W7Hc6GdQ/jvghHd89a', 1);
-- --password
